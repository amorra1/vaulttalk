...
struct qt_meta_stringdata_CLASSnetworkingENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSnetworkingENDCLASS = QtMocHelpers::stringData(
    "networking",
    "onConnected",
    "",
    "onDisconnected",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSnetworkingENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject networking::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSnetworkingENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSnetworkingENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSnetworkingENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<networking, std::true_type>,
        // method 'onConnected'
...
void *networking::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSnetworkingENDCLASS.stringdata0))
